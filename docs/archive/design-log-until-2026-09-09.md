# Design Log — lưu trữ các mục tới 2026-09-09

> Rotate theo **Protocol C.2/C.3** ngày **2026-09-18**: các mục nhật ký thiết kế từ 2026-09-06 đến
> 2026-09-09 được chuyển **nguyên văn** từ `docs/design-log.md` sang đây để file sống nằm trong ngân
> sách 8.000 dòng. **Không xoá một chữ nào** — chỉ chuyển chỗ (R7-03).

## Mục lục các mục đã lưu trữ
