# Test Report — lưu trữ (tới 2026-09-10)

> Tách khỏi `docs/test-report.md` ngày **2026-09-10** theo **Protocol C** (kỷ luật tài liệu,
> CLAUDE.md). Nội dung giữ **nguyên văn**, không sửa một chữ. File gốc chỉ giữ 11 đợt QA gần
> nhất để agent nạp được trong 1 lần đọc; toàn bộ 49 đợt trước nằm ở đây.
>
> Tra cứu: Ctrl+F theo tiêu đề đợt, hoặc `git log -p -- docs/test-report.md`.
