# CHANGELOG — Archive (đến 2026-09-08, trước US-20)

Nội dung archive từ `docs/CHANGELOG.md` (Protocol C.2, rotate đợt 1 — 2026-09-18). Chuyển
NGUYÊN VĂN, không sửa/tóm tắt. Khoảng thời gian: Increment 1 (project scaffolding) tới
Bug #8 fix (2026-09-08), trước khi US-20 "Các từ mới" mở đầu phần còn giữ lại trong file sống.
...
- Bug #7 fix — bước 7.0 (spike) + 7.1 (ship) — sitecustomize shim loại ký tự trắng khỏi phép đếm va chạm tách dòng (2026-09-07)
- Bug #7 fix — bước 7.2 (Ca A) — tách paragraph numbered-list theo marker tăng dần (B-2b) (2026-09-07)
- Bug #7 fix — bước 7.3 (Ca C, mục lục) — CHỈ ĐO LẠI, KHÔNG code gì (2026-09-07)
- Hotfix bước 7.2 — `unicode=""` khiến mục numbered-list bị BỎ DỊCH, không phải "LLM fallback" như đã ghi nhầm (phát hiện bởi Domain Expert, 2026-09-07)
...
- US-15 — Markdown parse-only, nhánh PDF (born-digital + scan) — implement theo Architecture.md §6.15 (2026-09-08)
